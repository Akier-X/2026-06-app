...
const INTENT_KEYWORDS: [Intent, string[]][] = [
  ['crisis', ['死にたい', '死にたく', '消えたい', '消えてなくなりたい', '自傷', 'リストカット', '自殺', '生きるのが', '生きていたくない', 'いなくなりたい', '消えてしまいたい', '終わりにしたい', '楽になりたい']],
...
const CRISIS_RESPONSE =
  'つらい気持ちを打ち明けてくれて、ありがとうございます。\n\nわたしはAIなので、いまのあなたに必要な支えになりきれません。どうか一人で抱え込まず、今すぐ専門の相談窓口に話してみてください。\n\n📞 よりそいホットライン（24時間・無料）\n0120-279-338\n\n📞 いのちの電話\n0120-783-556\n\n🌐 まもろうよ こころ（厚生労働省）\nhttps://www.mhlw.go.jp/mamorouyokokoro/\n\nあなたのことをとても心配しています。あなたの存在は大切です。';
